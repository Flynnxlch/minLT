...
export const CATEGORY_OPTIONS = [
  'Risiko Fiskal - Dividen',
  'Risiko Fiskal - PMN',
  'Risiko Fiskal - Subsidi & Kompensasi',
  'Risiko Kebijakan - SDM',
  'Risiko Kebijakan - Sektoral',
  'Risiko Komposisi - Konsentrasi Portofolio',
  'Risiko Struktur - Struktur Korporasi',
  'Risiko Restrukturisasi & Reorganisasi - Penggabungan, Pengambilalihan, Peleburan, Pemisahan, Pembubaran, Likuidasi, Kemitraan, dan Restrukturisasi',
  'Risiko Industri Umum - Formulasi Strategis',
  'Risiko Industri Umum - Pasar & Makroekonomi',
  'Risiko Industri Umum - Keuangan',
  'Risiko Industri Umum - Reputasi & Kepatuhan',
  'Risiko Industri Umum - Proyek',
  'Risiko Industri Umum - Teknologi & Keamanan Siber',
  'Risiko Industri Umum - Sosial & Lingkungan',
  'Risiko Industri Umum - Operasional',
  'Risiko Industri Perbankan - Kredit',
  'Risiko Industri Perbankan - Likuiditas',
  'Risiko Industri Asuransi - Investasi',
  'Risiko Industri Asuransi - Aktuarial',
];
