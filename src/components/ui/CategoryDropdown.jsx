...
export const CATEGORY_OPTIONS = [
  'Risiko Strategis - PMN',
  'Risiko Strategis - Struktur Korporasi',
  'Risiko Strategis - Formulasi Strategis',
  'Risiko Pasar - Makroekonomi',
  'Risiko Keuangan - Keuangan',
  'Risiko Credit/Counterparty Credit - Keuangan',
  'Risiko Operasional - Kebijakan SDM',
  'Risiko Operasional - Teknologi Informasi & Keamanan Siber',
  'Risiko Operasional - Sosial & Lingkungan',
  ...
  'Risiko Investasi/Proyek - M&A, JV, Restru',
  'Risiko Investasi/Proyek - Proyek',
  'Risiko Reputasi - Hukum, Reputasi & Kepatuhan',
  'Risiko Regulasi, Hukum & Kepatuhan - Kebijakan Sektoral',
];
